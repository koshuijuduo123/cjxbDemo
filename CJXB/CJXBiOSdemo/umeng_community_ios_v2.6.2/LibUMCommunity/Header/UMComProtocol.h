...
#define CommunityUserSignUp         @"user/signup"      // 微社区-用户注册
#define CommunityUserLoginWsq       @"user/login/wsq"   // 微社区-用户登录
#define CommunityUserForgetPwd      @"user/forget_pwd"  // 微社区-忘记密码
