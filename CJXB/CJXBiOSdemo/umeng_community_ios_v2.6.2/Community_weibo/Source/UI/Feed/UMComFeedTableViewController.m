...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(UMnotificationAction:) name:@"UMTASK" object:nil];
...
//通知友盟刷新
-(void)UMnotificationAction:(NSNotification *)ontification{
