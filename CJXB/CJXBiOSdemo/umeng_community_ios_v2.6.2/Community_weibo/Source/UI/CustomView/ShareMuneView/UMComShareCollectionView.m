...
- (void)resetSubViewsFrame
{
    ...
    if ([[UMComShareManager shareInstance].shareHadleDelegate isWechatInstalled]) {
    ...
    self.titleList = @[@"新浪微博",@"朋友圈",@"微信",@"Qzone",@"QQ"];
        ...
        self.imageNameList = [NSArray arrayWithObjects:@"um_sina_logo",@"um_qzone_logo",@"um_qq_logo", nil];
        self.titleList = @[@"新浪微博",@"Qzone",@"QQ"];
    }
}
