        ...
        case JGTypeOfUpLeft: {
            {
                ...
                CGFloat sizewidth = self.width;
                CGFloat sizeheight = self.height;
                [self startAnimateView_x:origin_x _y:origin_y origin_width:sizewidth origin_height:sizeheight];
            }
            break;
        }
        case JGTypeOfUpCenter: {
